...
# Last modified : 2022-02-27 12:37:20
...
download(){
    ...
    wget -O /usr/bin/dumb-init https://github.com/Yelp/dumb-init/releases/download/v${IMAU_DUMP_INIT}/dumb-init_${IMAU_DUMP_INIT}_x86_64 
